<script lang="ts">
  ...
  async function loadPoeStats() {
    try {
      ...
      console.error("Failed to load PoE stats:", e);
    }
  }
...
<div class="content-area">
  ...
  <div class="card">
    <div class="form-group">
      ...
      <input id="knowledge-title" type="text" bind:value={title} placeholder="Entry title" />
    </div>
    <div class="form-group">
      <label for="knowledge-content">Content</label>
      <textarea id="knowledge-content" bind:value={content} rows="6" placeholder="Knowledge content"></textarea>
    </div>
    <div class="form-group">
      <label for="knowledge-citations">Citations</label>
      <input id="knowledge-citations" type="text" bind:value={citations} placeholder="Sources, comma separated" />
    </div>
    {#if submitError}
  ...
  <div class="search-row">
    <input type="text" bind:value={searchQuery} placeholder="Search knowledge entries" on:keydown={handleSearchKeydown} aria-label="Search knowledge entries" />
